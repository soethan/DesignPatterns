...
namespace DesignPatterns
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            ConsoleWriteWithColor("*********** Iterator Pattern starts ***********");
            ...
            Console.WriteLine("collection[3]=" + (collection[3] as Item).Name);
            ...
            ConsoleWriteWithColor("*********** Iterator Pattern ends ***********");
            ...
            ConsoleWriteWithColor("*********** Memento Pattern starts ***********");
            ...
            ConsoleWriteWithColor("*********** Memento Pattern ends ***********");
